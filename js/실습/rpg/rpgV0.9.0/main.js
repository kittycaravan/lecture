...
function endBattle() {
    ...
    //todo 출력 전환
    dw("불쌍한 " + orc.name + ", " + elf.name + "에게 경험치 " + orc.exp + "을 주고 죽었습니다.\n");
    // br();
    getReward();
...
function procBattleTurn() {
    ...
    //todo 출력 전환
    dw(elf.name + "가 " + orc.name + "에게 데미지를 " + playerDamage + " 입혔습니다.\n");
    elf.currentHp = elf.currentHp - monsterDamage;
    //todo 출력 전환
    dw(orc.name + "가 " + elf.name + "에게 데미지를 " + monsterDamage + " 입혔습니다.\n");
