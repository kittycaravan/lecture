...
/* 몬스터 배치 */
var monsterArray = [
    new Monster("허수아비", 100, 1, 1001),    
    new Monster("허수아비", 100, 1, 1002),    
    new Monster("허수아비", 100, 1, 1003),    
    new Monster("허수아비", 100, 1, 1004),    
    new Monster("쥐", 50, 5, 1006),
    new Monster("쥐", 50, 5, 1005),
    new Monster("왕쥐", 150, 15, 1006)
]
