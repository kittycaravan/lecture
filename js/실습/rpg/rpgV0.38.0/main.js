...
var elf = new Character("엠피스", 200, 30); // 플레이어 케릭터 생성(초기화)
...
/* 몬스터 배치 */
var monsterArray = [
    new Monster("001","허수아비", 100, 1, 1001, "N", 100),    
    new Monster("002","허수아비", 100, 1, 1002, "N", 100),    
    new Monster("003","허수아비", 100, 1, 1003, "N", 100),    
    new Monster("004","허수아비", 100, 1, 1004, "N", 100),    
    new Monster("005","쥐", 50, 5, 1006, "H", 200),
    new Monster("006","쥐", 50, 5, 1005, "H", 200),
    new Monster("007","왕쥐", 150, 15, 1006, "H", 500)
]
...
/* 가방에 기본 아이템 추가 */
bagItemArray.push(
    new BagItem("체력 회복 물약(HP50)", "B-1", "체력물약", 50),
    new BagItem("체력 회복 물약(HP100)", "B-2", "체력물약", 100)
);
